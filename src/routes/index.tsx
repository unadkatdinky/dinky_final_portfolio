...
import smiley from "@/assets/smiley-sticker.png";
import headphones from "@/assets/headphones-doodle.png";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Scrapbook-style portfolio of Dinky, a full stack developer who ships clean, thoughtful products." },
      { property: "og:title", content: "Dinky — Full Stack Developer" },
      { property: "og:description", content: "Full stack developer portfolio. Projects, skills, experience, and a bit of personality." },
    ],
  }),
  component: Index,
});
...
/* -------------------- Folder -------------------- */
function Folder({ label, href, download, color = "var(--accent-blue)" }: { label: string; href: string; download?: boolean; color?: string }) {
  return (
    <motion.a
      href={href}
      download={download}
    ...
    >
      <div className="relative w-24 h-20">
        <div className="absolute top-0 left-2 w-12 h-3 rounded-t-md" style={{ background: color }} />
        <div className="absolute top-2 left-0 right-0 bottom-0 rounded-md shadow-[3px_3px_0_rgba(0,0,0,0.15)]" style={{ background: `color-mix(in oklab, ${color} 65%, white)` }} />
        <div className="absolute top-3 left-1 right-1 bottom-1 rounded-md border-2" style={{ background: `color-mix(in oklab, ${color} 35%, white)`, borderColor: color }} />
      </div>
...
function Hero() {
  ...
  return (
    <section id="top" ref={ref} className="px-4 sm:px-6 py-10">
      <div className="max-w-5xl mx-auto rounded-md shadow-[0_30px_80px_-30px_rgba(0,0,0,0.35)] overflow-hidden border border-border bg-paper">
        <div className="flex items-center justify-between px-6 py-2 bg-[oklch(0.96_0.02_85)] border-b border-[oklch(0.85_0.03_85)]">
          {Array.from({ length: 14 }).map((_, i) => (
            <div key={i} className="spiral-ring" />
          ))}
        </div>
        <div className="bg-grid p-6 sm:p-10 relative">
          <div className="border border-[var(--accent-blue)]/70 rounded-sm p-6 sm:p-10 relative overflow-hidden">
            <motion.h1
...
/>
            ...
            <div className="relative mt-10 grid grid-cols-12 gap-6 items-start">
              ...
              >
                {/* 📷 Drop your real photo at src/assets/my-photo.png to replace this. */}
                <img
                  src={portrait}
                  alt="Portrait of Dinky"
                  width={896}
                  height={1152}
                  className="w-full max-w-[280px] object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.15)]"
                />
                <motion.img
                  src={smiley}
                  alt=""
                  ...
                  className="absolute -left-2 top-4 w-16 sm:w-20"
                />
                <motion.img
                  src={headphones}
                  alt=""
                  ...
                  className="absolute -right-2 top-2 w-16 sm:w-20"
                />
              </motion.div>
...
function Index() {
  ...
  return (
    <main className="min-h-screen bg-paper text-ink overflow-x-clip">
      ...
      {/* ABOUT (light) */}
      <section id="about" className="px-4 sm:px-6 py-20 bg-grid">
        <div className="max-w-5xl mx-auto">
          <Typewriter
            text="about me."
            className="font-display italic text-5xl sm:text-6xl text-center mb-3"
          />
      ...
      {/* PROJECTS (DARK) */}
      <section id="projects" className="section-dark px-4 sm:px-6 py-24">
      ...
      <section id="skills" className="px-4 sm:px-6 py-24">
        <div className="max-w-5xl mx-auto">
          <Typewriter
            text="skills & tools."
            className="font-display italic text-4xl sm:text-5xl text-center mb-10"
          />
      ...
      {/* EXPERIENCE (DARK) */}
      <section id="experience" className="section-dark px-4 sm:px-6 py-24">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          <div>
            <Typewriter text="experience." className="font-display italic text-4xl sm:text-5xl mb-8" />
          ...
          <div id="education">
            <Typewriter text="education." className="font-display italic text-4xl sm:text-5xl mb-8" />
            <div className="space-y-6">
              {[
      ...
      {/* CONTACT (light) */}
      <section id="contact" className="px-4 sm:px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          <Typewriter
            text="let's build something."
            className="font-display italic text-4xl sm:text-6xl text-[var(--accent-blue)] mb-4"
          />
